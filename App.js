              ...
              tabBarIcon: ({ focused, size }) => (
                <View style={(size = { size })}>
                  <Image
                    source={
                      focused
                        ? require("./src/img/home_color.png")
                        : require("./src/img/Home_nocolor.png")
                    }
                  />
                </View>
              ),
              ...
              tabBarIcon: ({ focused, size }) => (
                <View style={(size = 10000)}>
                  <Image
                    source={
                      focused
                        ? require("./src/img/shop_color.png")
                        : require("./src/img/shop.png")
                    }
                  />
                </View>
              ),
              ...
              tabBarIcon: ({ focused, size }) => (
                <View style={(size = { size })}>
                  <Image
                    source={
                      focused
                        ? require("./src/img/hand_color.png")
                        : require("./src/img/hand.png")
                    }
                  />
                </View>
              ),
              ...
              tabBarIcon: ({ focused, size }) => (
                <View style={(size = { size })}>
                  <Image
                    source={
                      focused
                        ? require("./src/img/perfil_selected.png")
                        : require("./src/img/perfil_unselected.png")
                    }
                  />
                </View>
              ),
